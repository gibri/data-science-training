...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unrate = recession_data.groupby(['unemployment_rate','Vehicle_Type'])['Automobile_Sales'].mean().reset_index()
        R_chart4=dcc.Graph(figure=px.bar(unrate,x='unemployment_rate',y='Automobile_Sales',color='Vehicle_Type',
...
#TASK 2.5: Creating Graphs Yearly data
        ...
        #Y_chart1 = dcc.Graph(figure=px.line(figure=px.line(yas, x='Year', y='Automobile_Sales'))

        # Plot 2 Total Monthly Automobile sales using line chart.
        msales = yearly_data.groupby('Month')['Automobile_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(figure=px.line(msales,x='Month',y='Automobile_Sales', title='Total Monthly Automobile sales'))
